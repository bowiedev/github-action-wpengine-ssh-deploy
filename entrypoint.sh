...
rsync --rsh="ssh -v -p 22 -i /github/home/.ssh/github_action.pub -o StrictHostKeyChecking=no" -a --exclude 'node_modules' --exclude=".*" . selive@selive.ssh.wpengine.net:sites/selive/
